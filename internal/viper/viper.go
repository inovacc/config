...
import (
	...
	"github.com/dyammarcano/config/internal/viper/internal/features"
)
...
func New() *Viper {
	...
	return &Viper{
		...
		pflags:                 make(map[string]FlagValue),
		env:                    make(map[string][]string),
		aliases:                make(map[string]string),
		encoderRegistry:        codecRegistry,
		decoderRegistry:        codecRegistry,
		experimentalFinder:     features.Finder,
		experimentalBindStruct: features.BindStruct,
	}
}
